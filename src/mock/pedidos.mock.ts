...
export interface FinanceiroResumo {
  faturado:           number   // concluido
  aguardandoPagamento: number  // pagamento_pendente
  emAberto:           number   // aguardando_aprovacao + em_preparo + saiu_para_entrega + entregue
  totalGeral:         number   // soma dos três acima
