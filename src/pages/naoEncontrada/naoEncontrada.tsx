    ...
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      <div className="hidden lg:flex w-2/3 relative overflow-hidden bg-zinc-900 flex-col justify-between p-12">
        ...
        <div className="relative z-10 select-none">
          <p
            className="text-zinc-800 leading-none"
            style={{
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          {/* Badge erro */}
          <div className="inline-flex items-center gap-2 border border-zinc-800 bg-zinc-900 px-3 py-1.5 mb-8">
          ...
          <div className="space-y-3">
            <button
              ...
              className="
                ...
                uppercase tracking-widest py-3 px-6
            ...
            <button
              ...
              className="
                w-full bg-transparent border border-zinc-800 text-zinc-500 font-mono text-sm
                uppercase tracking-widest py-3 px-6
