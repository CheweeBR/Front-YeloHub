...
export default function Header() {
  ...
  return (
    <>
        ...
        <div className="mx-auto px-6 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-1">
              <CanAccess roles={['admin', 'vendedor', 'cliente']}>
          ...
          {/* Direita: user + logout (desktop) | hambúrguer (mobile) */}
      ...
      <div
        className={`
          fixed top-0 right-0 h-full w-72 bg-zinc-900 border-l border-zinc-800 z-50 md:hidden
          flex flex-col
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-2">
          <CanAccess roles={['admin', 'vendedor', 'cliente']}>
            <NavLink to="/catalogo" className={drawerLinkClass} onClick={closeDrawer}>
              Catálogo
            </NavLink>
          </CanAccess>
